  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto px-8 py-16 md:px-16" style={{ maxWidth: 1400 }}>
        <p className="mb-10 text-xs text-black/35" style={{ fontFamily:"Jost,sans-serif" }}>{events.length} events</p>
